...
for c in " 0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ.,-_()[]{}!?:;#'\"/\\%$`&=*+@^~|￡’£—»‘–”“…ü®°¬Ã¢∝é🔊ÁãÉﬁ閏™\xad":  # Handle stopwords
...
model.save("model/model.h5")											# output weight path
